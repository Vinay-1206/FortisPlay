...
/**
 * In a real application this would call an API route / backend service.
 * For this starter it returns static data shaped exactly like the
 * FortisPlay "Live Events" dashboard so the UI can be built against it.
 */
export async function getLiveEvents(): Promise<EventGroup[]> {
